...
const Interestfarmer = () => {
  ...
  const handleInterestStatus = async (interestId, status) => {
    ...
    try {
      ...
      // 👇 Send with correct snake_case param
  ...
  return (
    <div
      style={{
        ...
        // Make background fixed so it doesn't scroll
        backgroundAttachment: "fixed",
        overflow: "hidden", // disable scrolling of whole page
      }}
    >
      ...
      <div
        style={{
          flex: 1,
          display: "flex",
          overflow: "hidden", // prevent scroll in outer container

          minHeight: 0, // needed for flex child scroll on Firefox
        }}
      >
        <VerticalNavbar />
        ...
        <main
          style={{
            ...
            // Make this area scrollable ONLY
            overflowY: "auto",
            overflowX: "auto",

            minHeight: 0, // important for Firefox scroll
          }}
        >
          ...
          {!loading && !error && interests.length > 0 && (
            <table
              style={{
                ...
                color: "white",
                fontSize: "1rem",
                minWidth: "600px", // force horizontal scroll on small screens if needed
              }}
            >
              <thead>
              ...
              <tbody>
                {interests.map((interest) => (
                  <tr key={interest.id} style={{ borderBottom: "1px solid #555" }}>
                    ...
                    <td style={{ padding: "10px" }}>{interest.status}</td>
                    <td style={{ padding: "10px" }}>
                      {new Date(
